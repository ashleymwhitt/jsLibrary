...
var netflix = {
    ...
    name: "Super Store",
      season1: {
        seasonInfo: {
          episodeInfo : [ /* the following is an array of objects, nested: */
    ...
    // console.log(netflix.name) /*--> will give you the value of key"name"*/

    console.log(netflix.season1.seasonInfo.episodeInfo[7]);
    console.log(netflix.season1.seasonInfo.episodeInfo[4].episodeName); /*--> gives you the episode name.*/
    ...
    //   Capital"O" in Object to get interface
    //   console.log(Object.keys(spaceJam.nbaPlayers)[0]) /* use the index to dig through array*/
